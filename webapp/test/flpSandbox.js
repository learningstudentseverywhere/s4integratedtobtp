		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "S4 Hana system Integrated to BTP",
									"targetURL": "#coms4integtobtps4integratedtobtp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"coms4integtobtps4integratedtobtp-display": {
								"semanticObject": "coms4integtobtps4integratedtobtp",
								"action": "display",
								"description": "s4 hana integrated to btp",
								"title": "S4 Hana system Integrated to BTP",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.s4integtobtp.s4integratedtobtp",
									"url": sap.ui.require.toUrl("com/s4integtobtp/s4integratedtobtp")
								}
							}
						}
					}
